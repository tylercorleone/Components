...
#define COMPONENTS_TWO_PI 6.283185307179586476925286766559
...
inline float _sin(float x) {
    return static_cast<float>(sin_fix(x / COMPONENTS_TWO_PI * UINT16_MAX)) / (0x1 << 14);
}

inline float _cos(float x) {
    return static_cast<float>(cos_fix(x / COMPONENTS_TWO_PI * UINT16_MAX)) / (0x1 << 14);
}
